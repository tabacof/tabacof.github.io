 ...
 * [**Shy Tory**](https://en.wikipedia.org/wiki/Shy_Tory_factor) and [**Bradley**](https://en.wikipedia.org/wiki/Bradley_effect) effects: Voters are not comfortable with revealing their particular preference.
...
![](bias_influence.png){fig-align="center"}
...
This blog post was written with the help of [Ramon Oliveira](https://www.linkedin.com/in/ramon-de-oliveira/) back when we were working in a data science consulting company (Datart) that we co-founded together.